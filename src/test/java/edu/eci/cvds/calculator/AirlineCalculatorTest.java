...
public class AirlineCalculatorTest {
	...
	public void calculateTest() {
		...
		if (SeatCategory.FIRST_CLASS.equals(category)&& seatsNumber<=15 && calculate.getCost().get()==precio){
			return (calculate.getResult()==BookingResult.SUCCESS);

		}
		if (SeatCategory.EMERGENCY_DOOR.equals(category) && seatsNumber<=8 && calculate.getCost().get()==precio){
			return (calculate.getResult()==BookingResult.SUCCESS);
		}	
