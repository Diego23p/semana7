...
public class BookingServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int x=Integer.parseInt(req.getParameter("seats"));
		String y= req.getParameter("seatCategory");
		SeatCategory categoria = SeatCategory.valueOf(y);

		
		BookingOutput response = calculator.calculate(x,categoria);
